...
public class OngServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        List<Ong> ong = RepositorioOng.readAll();
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<tr><th>Código</th><th>CNPJ</th><th>e-mail</th>"
                    + "<th>Telefone Contato</th><th>Ação</th></tr>");
                    
                    for(Ong uAux: ong){
                        out.println("<tr>");
                        out.println("<td>"+uAux.getCodigo()+"</td>");
                        out.println("<td>"+uAux.getCnpj()+"</td>");
                        out.println("<td>"+uAux.getEmail()+"</td>");
                        out.println("<td>"+uAux.getTelefone()+"</td>");
                        out.println("<td><a href='OngServlet?codigo="+uAux.getCodigo()+"'>detalhar</a></td>" );
                        out.println("</tr>");
                    }
